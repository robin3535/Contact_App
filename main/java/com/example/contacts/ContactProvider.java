...
/**
 * {@link ContentProvider} for Contacts app.
 */
public class ContactProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        Integer weight = values.getAsInteger(ContactEntry.COLUMN_CONTACT_WEIGHT);
        if (weight != null && weight < 0) {
            throw new IllegalArgumentException("Contact requires valid weight");
        }
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ContactEntry#COLUMN_CONTACT_WEIGHT} key is present,
        // check that the weight value is valid.
        if (values.containsKey(ContactEntry.COLUMN_CONTACT_WEIGHT)) {
