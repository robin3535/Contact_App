...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertPet() {
        ...
        values.put(ContactEntry.COLUMN_CONTACT_NAME, "Robin Kumar");
        values.put(ContactEntry.COLUMN_CONTACT_BREED, "My Number");
        values.put(ContactEntry.COLUMN_CONTACT_GENDER, ContactEntry.GENDER_UNKNOWN);
        values.put(ContactEntry.COLUMN_CONTACT_WEIGHT, "9931873211");
